    ...
    <footer className="bg-black text-white py-16 font-roboto">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-8 h-8 flex items-center justify-center border border-gray-600 hover:border-[#A020F0] hover:text-[#A020F0] transition-colors duration-200"
              >
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="#"
                  className="text-gray-300 hover:text-[#A020F0] transition-colors duration-200 font-roboto font-light text-sm"
                >
                  Gaming
                </a>
              </li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <a
            href="#"
            className="text-gray-400 hover:text-[#A020F0] transition-colors duration-200 text-sm font-roboto font-light mt-4 md:mt-0"
          >
            Term & Condition
          </a>
        </div>
