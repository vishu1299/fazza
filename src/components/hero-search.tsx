          ...
          <div className="flex-1 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-2xl">
            <div className="relative">
              <Input
                ...
                className="w-full h-8 sm:h-9 md:h-10 lg:h-12 pl-3 sm:pl-4 pr-9 sm:pr-10 md:pr-12 lg:pr-14 bg-purple-50 border border-[var(--primary)] rounded-full text-xs sm:text-sm text-gray-700 placeholder-gray-400 outline-[var(--primary)] outline-4 focus:border-[var(--primary)] font-roboto transition-all duration-200"
              />
              <Button
