        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 sm:p-6 bg-gray-50 rounded-xl">
            ...
            <Button
              variant="outline"
              size="sm"
              className="text-purple-600 border-purple-600 hover:bg-purple-50 px-6 py-2 rounded-full font-medium"
            >
              Edit
            </Button>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 sm:p-6 bg-gray-50 rounded-xl">
            ...
            <Button
              variant="outline"
              size="sm"
              className="text-purple-600 border-purple-600 hover:bg-purple-50 px-4 py-2 rounded-full font-medium"
            >
              Change Password
            </Button>
          </div>
