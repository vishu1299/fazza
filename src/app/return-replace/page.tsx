        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8">
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            ...
            <div className="mb-4">
              <Button
                variant="outline"
                className="text-purple-600 border-purple-600 hover:bg-purple-50 mb-4"
              >
                Add a new Address +
              </Button>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            ...
            <div className="flex justify-center">
              <Button
                ...
                className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 rounded-full font-medium text-base"
              >
                Submit
              </Button>
            </div>
